...
let profiling_306 = [
    {enabled:false, startAddr:0x50b1, endAddr:0x56b2}, // aprox 68000 cycles
    {enabled:false, startAddr:0x4a3d, endAddr:0x4ebe},
    {enabled:false, startAddr:0x677A, endAddr:0x6798, label:'all down'}, // 73000 cycles, 
    ...
    {enabled:false, startAddr:0x6795, endAddr:0x6798, label:'FUN_CODE_63e0_called_from_main_loop callsite'}, // 101 cycles, 

    {enabled:false, startAddr:0x50b1, endAddr:0x51dd},
    {enabled:false, startAddr:0x51dd, endAddr:0x51e0}, // 26320 cycles
    {enabled:false, startAddr:0xebe7, endAddr:0xefaf}, // 2000 cycles
    ...
    {enabled:false, startAddr:0x6774, endAddr:0x6798}, // 70000 cycles aprox
    {enabled:false, startAddr:0x674b, endAddr:0x674e},
    {enabled:false, startAddr:0x6720, endAddr:0x6723},
    {enabled:false, startAddr:0x674e, endAddr:0x6751}, // 50000  cycles aprox
    {enabled:false, startAddr:0x31c3, endAddr:0x3276},
    {enabled:false, startAddr:0xe84e, endAddr:0xe902},
    {enabled:false, startAddr:0xe564, endAddr:0xe657},
    {enabled:false, startAddr:0x665F, endAddr:0x6798, label:'main loop'}, // 
    {enabled:false, startAddr:0x6A6A, endAddr:0x6B2B, label:'UART RX IRQ handler original'}, // 
    {enabled:false, startAddr:0x6A6A, endAddr:0x6A99, label:'UART RX IRQ handler patched'}, // 
];
