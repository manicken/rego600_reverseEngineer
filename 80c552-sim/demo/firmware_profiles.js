...
let entry_points_3060 = [
    ...
    {addr:0x952A, label:"menu_type_00_trampoline"},
    {addr:0x9530, label:"menu_type_01_trampoline"},
    {addr:0x953C, label:"menu_type_05_trampoline"},
    {addr:0x9542, label:"menu_type_06_trampoline"},
    {addr:0x9547, label:"menu_type_07_trampoline"},
    {addr:0x954C, label:"menu_type_08_trampoline"},
    {addr:0x9551, label:"menu_type_09_trampoline"},
    {addr:0x9556, label:"menu_type_0A_trampoline"},
    {addr:0x955B, label:"menu_type_0B_trampoline"},
    {addr:0x9560, label:"menu_type_0E_trampoline"},
    {addr:0x9565, label:"menu_type_0F_trampoline"},
    {addr:0x956A, label:"menu_type_10_trampoline"},
    {addr:0x956F, label:"menu_type_11_trampoline"},
    {addr:0x9574, label:"menu_type_12_trampoline"},
    {addr:0x9579, label:"menu_type_13_trampoline"},
    {addr:0x957E, label:"menu_type_14_trampoline"},
    {addr:0x9583, label:"menu_type_15_trampoline"},
    {addr:0x9588, label:"menu_type_16_trampoline"},
    {addr:0x958D, label:"menu_type_17_trampoline"},
    {addr:0x9592, label:"menu_type_18_trampoline"},
    {addr:0x959C, label:"menu_type_19_trampoline"},
    {addr:0x95A1, label:"menu_type_1A_trampoline"},
    {addr:0x95AB, label:"menu_type_1B_trampoline"},
    {addr:0x95B0, label:"menu_type_1C_trampoline"},
    {addr:0x95B5, label:"menu_type_1D_trampoline"},
    {addr:0x95BA, label:"menu_type_1E_trampoline"},
    {addr:0x95BF, label:"menu_type_1F_trampoline"},
    {addr:0x9597, label:"menu_type_20_trampoline"},
    {addr:0x95A6, label:"menu_type_21_trampoline"},
    {addr:0x9536, label:"menu_type_2D_trampoline"},
    {addr:0x95C6, label:"menu_type_RET_trampoline"},

    {addr:0x95C7, label:"menu_type_00_func"},
    {addr:0x95F2, label:"menu_type_01_func"},
    {addr:0x9822, label:"menu_type_04_2D_func"},
    {addr:0x9AD6, label:"menu_type_06_07_10_func"},
    //{addr:0x9AD6, label:"menu_type_07"},
    {addr:0xA510, label:"menu_type_08_func"},
    {addr:0xA5B8, label:"menu_type_09_func"},
    {addr:0xA894, label:"menu_type_0A_func"},
    {addr:0xA902, label:"menu_type_0B_RTC_SET"},
    {addr:0xAE58, label:"menu_type_0E_func"},
    {addr:0xB5BE, label:"menu_type_0F_func"},
    //{addr:0x9AD6, label:"menu_type_10_func"},
    {addr:0xB92F, label:"menu_type_11_func"},
    {addr:0xBBF3, label:"menu_type_12_func"},
    {addr:0xBEAC, label:"menu_type_13_func"},
    {addr:0xC3FD, label:"menu_type_14_func"},
    {addr:0xC476, label:"menu_type_15_func"}, // THIS is the only meny type that can print the mysterious 'Adress' string
    {addr:0xC6CC, label:"menu_type_16_func"},
    {addr:0xC9DC, label:"menu_type_17_func"},
    {addr:0xCAA2, label:"menu_type_18_func"},
    {addr:0xCB87, label:"menu_type_19_func"},
    {addr:0xCD87, label:"menu_type_1A_ROOT_MENU"},
    {addr:0xD836, label:"menu_type_1B_LOG_VIEW"},
    {addr:0xD22D, label:"menu_type_1C_func"},
    {addr:0xDA49, label:"menu_type_1D_func"},
    {addr:0xDD18, label:"menu_type_1E_func"},
    {addr:0xDE23, label:"menu_type_1F_func"},
    {addr:0xCB13, label:"menu_type_20_func"},
    {addr:0xD46C, label:"menu_type_21_func"},

    {addr:0xD402, label:"show_current_access_level"},
    {addr:0xD41F, label:"show_current_access_level_01"},
    {addr:0xD432, label:"show_current_access_level_02"},
    {addr:0xD445, label:"show_current_access_level_04"},
    {addr:0xD458, label:"show_current_access_level_08"},
    {addr:0xD46B, label:"show_current_access_level_RET"},
    //{addr:0x9822, label:"menu_type_2D"},
];
